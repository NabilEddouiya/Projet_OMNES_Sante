<?php
    ...
    if (isset($_GET['logout'])){ 
        ...
        $_SESSION['client'] . "</b> a quitté la session de chat.</span><br></div>";
    ...
    if (isset($_POST['enter'])) {
        if($_POST['client'] != "") {
        $_SESSION['client'] = stripslashes(htmlspecialchars($_POST['name']));
        }
        else {
...
<html>
    ...
    <body>
        <?php
            ...
            <div id="wrapper">
                <div id="menu">
                    <p class="welcome">Bienvenue, <b><?php echo $_SESSION['client']; ?></b></p>
                    <p class="logout"><a id="exit" href="AffichageMedecin.php">Quitter la conversation</a></p>
                </div>
                <div id="chatbox">
                    <?php
