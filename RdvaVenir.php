    ...
    <body>
        ...
        <?php
            ...
            if ($db_found) { 
                ...
                $sql1 = "SELECT DISTINCT c.ID_Consultation,m.Nom_m,cl.Nom,c.date_heure_debut,c.WeekDay,c.Creneau FROM consultation c, client cl, medecin m WHERE (cl.Email=c.EmailClient AND cl.Email='$email' AND c.date_heure_debut>'$newdate' AND c.Medecin_ID=m.ID)";
