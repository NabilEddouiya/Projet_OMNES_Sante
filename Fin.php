...
<body>
    ...
    if ($choix == "") {
        ...
        if ($erreur == "") {
            ...
            $sql1 = "";
            if ($db_found) {
                $sql1 = "delete from consultation order by ID_Consultation DESC limit 1";
        ...
        echo "<h1>Merci d'avoir payer veuillez cliquez sur le bouton pour retourner a l'accueil</h1>";
        echo '<h3><a href="index.html">Accueil</a></h3>';
    }
    ?>
</body>
